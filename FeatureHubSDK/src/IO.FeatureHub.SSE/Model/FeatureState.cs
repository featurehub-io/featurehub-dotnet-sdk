...
namespace IO.FeatureHub.SSE.Model
{
    ...
    public partial class FeatureState : IEquatable<FeatureState>
    {
        ...
        public FeatureState(Guid id = default(Guid), string key = default(string), bool l = default(bool), long version = default(long), FeatureValueType? type = default(FeatureValueType?), object value = default(object), Guid environmentId = default(Guid), List<RolloutStrategy> strategies = default(List<RolloutStrategy>))
        {
            this.Id = id;
            this.Key = key;
            this.L = l;
